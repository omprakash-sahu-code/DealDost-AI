...
export default function DashboardLayout({
  ...
  return (
    <motion.div
      ...
      className="fixed inset-0 h-[100dvh] z-[100] flex bg-[#050505] text-[#F5F5F4] overflow-hidden"
    >
      ...
      <main data-lenis-prevent="true" className="flex-1 flex flex-col relative overflow-hidden h-[100dvh]">
